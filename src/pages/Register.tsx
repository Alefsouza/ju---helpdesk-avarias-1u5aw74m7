...
export default function Register() {
  ...
  const backgroundStyle = { backgroundImage: `url('${localBgImage}')` }

  if (isSuccess) {
    return (
      <div
        className="fixed inset-0 w-full h-full bg-[#1a472d] bg-cover bg-center bg-no-repeat transition-all duration-700 overflow-y-auto"
        style={backgroundStyle}
      >
        <div className="fixed inset-0 bg-gradient-to-b from-black/80 via-black/40 to-black/90 z-0 pointer-events-none" />
        <div className="relative z-10 w-full max-w-md mx-auto min-h-screen flex items-center justify-center py-8 px-4">
          <Card className="border-white/10 bg-black/30 backdrop-blur-md sm:backdrop-blur-lg shadow-2xl overflow-hidden w-full relative text-center py-6">
            <CardHeader>
